...
- **Multi-service support** — Monitor deployments from Vercel, Cloudflare Pages, GitHub Actions, Netlify, Railway, Zeabur, Fly.io, Xcode Cloud, and TestFlight
...
For Zeabur, an API key is enough for personal projects; add an Owner / Team ID for team-owned projects, and optionally add Project IDs to limit what StackLight watches.
...
- **多服务支持** — 监控 Vercel、Cloudflare Pages、GitHub Actions、Netlify、Railway、Zeabur、Fly.io、Xcode Cloud 和 TestFlight
...
Zeabur 个人项目只需要 API Key；团队项目可填写 Owner / Team ID，也可以额外填写 Project IDs 来限制监控范围。
